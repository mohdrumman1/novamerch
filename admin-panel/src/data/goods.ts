...
export const goods: Good[] = [
  ...
  // Alliance Group placeholders - cost/dims TBC, awaiting supplier confirmation
  {
    id: "good-022",
    sku: "BG-LUNCH",
    name: "Lunch Bag",
    ...
    weightKg: 0,
    qtyPerCarton: 0,
    supplierNotes: "Sell price (Alliance Group): $15.00 AUD. Cost/dims TBC, awaiting supplier confirmation.",
  },
  {
    id: "good-023",
    sku: "DW-MUG",
    ...
    weightKg: 0,
    qtyPerCarton: 0,
    supplierNotes: "Sell price (Alliance Group): $12.00 AUD. Cost/dims TBC, awaiting supplier confirmation.",
  },
  {
    id: "good-024",
    sku: "OF-NOTEBOOK",
    ...
    weightKg: 0,
    qtyPerCarton: 0,
    supplierNotes: "Sell price (Alliance Group): $10.00 AUD. Cost/dims TBC, awaiting supplier confirmation.",
  },
  {
    id: "good-025",
    sku: "DW-BOTTLE27",
    name: "27 Oz Drink Bottle",
    category: "Drinkware",
    costUsd: 0,
    logoFee: 0,
    minQty: 0,
    ...
    weightKg: 0,
    qtyPerCarton: 0,
    supplierNotes: "Sell price (Alliance Group): $24.00 AUD. Cost/dims TBC, awaiting supplier confirmation.",
  },
];
